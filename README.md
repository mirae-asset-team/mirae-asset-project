...
| 테스트 | 전체 Python `939 passed, 2 skipped, 260 subtests`; Web JS `13 passed`; 팀 QA `1 passed`; 배포·위생 `48 passed, 94 subtests` | private/provider 600건과 실제 staging identity 평가 |
