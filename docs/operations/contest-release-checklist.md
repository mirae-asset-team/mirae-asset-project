...
| Provider adapter schema smoke | FAIL_CLOSED | Text response did not satisfy the exact JSON schema; structured path returned deterministic `hcx_fallback` with validated citation/value |
