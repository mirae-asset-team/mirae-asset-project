...
- PDF verification: reopened with pypdf, 12 pages, 9,835 extracted characters, required text present, no Unicode replacement characters, all pages rendered with Poppler and visually inspected. Header/footer ordering defects found on the first render were fixed before final output. Final SHA-256: `0812179582f69025a508b43e654e8169222117c4dbbe96118d3da726de802829`. Commits `0cd5673` and `746d338`.
